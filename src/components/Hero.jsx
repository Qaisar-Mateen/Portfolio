...
function Particles() {
  const sceneUrl = isMobileDevice()
    ...
    : "https://prod.spline.design/k52-LDbN7C12ciir/scene.splinecode";
  return (
    <div>
      <Spline
        scene={sceneUrl}
...
const Hero = () => {
  return (
    ...
    <section className="relative w-full h-screen mx-auto">
      <div  className={`absolute inset-0 top-[120px] max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`} style={{zIndex: 1, pointerEvents: 'none'}}> 
